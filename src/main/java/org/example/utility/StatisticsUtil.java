...
public class StatisticsUtil {
    ...
    public static List<Statistics> formStatistics(List<Student> studentList,
        ...
        logger.log(Level.INFO, "Calculating statistics started");
...
// складываем в одну строку названия универов по профилю, наверное короткие
        ...
        logger.log(Level.INFO, "Calculating statistics finished successfully. \n "
                +"Statistic list is "+ statisticsList.size()+" rows long. ");
